...
val<-res[ grepl("val:",res$V1) & grepl("TOTAL",res$V2),]
...
print(head(res[ grepl("train",res$V1),"V7"]))
print(head(res[ grepl("val:",res$V1) & grepl("TOTAL",res$V2),"V7"]))
...
lines(1:epochs, res[ grepl("val:",res$V1) & grepl("TOTAL",res$V2),"V7"],col="blue")
...
lines(1:epochs, 1-res[ grepl("val:",res$V1) & grepl("TOTAL",res$V2),"V5"],col="blue")
legend("topright",c("val","train"),fill=c("blue","red"))
