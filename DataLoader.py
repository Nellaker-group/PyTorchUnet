...
def get_dataloader(trainDir, valDir,imageDir,preName,ifAugment,noTiles,augSeed,ifSizeBased,frank,inputChannels,normFile,input512):
    ...
    if imageDir:
        # read in data
        train_set = GetDataFolder("train", preName, augSeed, frank, inputChannels, normFile, input512, pathDir=trainDir, transform=trans, ifAugment=ifAugment)
