...
class RandomSampler(Sampler):
    ...
    def __init__(self, data_source, sample_size, shape, counter, seed=-9):
    ...
    def __iter__(self):        
        ...
        # for validation set seed, so sampling is always the same
        if self.seed > 0:
...
class SeqSamplerDatasetSize(Sampler):
    ...
    def __iter__(self):        
        ...
        for sample_idx in range(self.sample_size):
            ...
            if rand_var < 4:
                y0, x0 = rd.choice(list(range(0, (rangeH+1), 1024))), rd.choice(list(range(0, (rangeW+1), 1024)))
                index=0
            elif rand_var >= 4 and rand_var < 9:
                y0, x0 = rd.choice(list(range(0, (rangeH2+1), 1024))), rd.choice(list(range(0, (rangeW2+1), 1024)))
                index=1
            elif rand_var >= 9 and rand_var < 85:
                y0, x0 = rd.choice(list(range(0, (rangeH3+1), 1024))), rd.choice(list(range(0, (rangeW3+1), 1024)))
                index=2
            elif rand_var >= 85:                
                y0, x0 = rd.choice(list(range(0, (rangeH4+1), 1024))), rd.choice(list(range(0, (rangeW4+1), 1024)))
                index=3
